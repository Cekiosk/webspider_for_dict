...
def open_url(url):#第二个参数是usragent
    ...
    httpproxy_handler = urllib.request.ProxyHandler({"http": "http://61.128.208.94:3128/"})#96
    ...
    headers = {
        ...
        'Cookie': '_ga=GA1.3.1581630178.1544052280; 1P_JAR=2018-12-12-8; NID=150=ejR_SuMimM2rKsY2M4LjLgxQbaLdKpZ_GnUxl48Y1eLUBOxLfmbaNqX5HmKDGWhUwxdboJTeqAGiLL_-b5nWD162S-xIQ0-02uMZo_QQ-xowJO4244Za2zecyqI46684cuSnnoquDx4WF-s7dkoEsxymA6vkQrZcvm9BNLrJe78'#我得想想怎么得到cookie
...
def translate(content, tk):
    ...
    result = open_url(urlde)#组装包的过程在这个函数里面
